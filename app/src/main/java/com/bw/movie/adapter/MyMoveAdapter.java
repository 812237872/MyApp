...
public class MyMoveAdapter extends RecyclerView.Adapter<MyMoveAdapter.ViewHolder> {
    Context context;
    List<HotMove> list;
    HotMoveFragment hotMoveFragment;
    Listener listener;
    public MyMoveAdapter(Context context, List<HotMove> list, HotMoveFragment hotMoveFragment) {
        this.context = context;
        this.list = list;
        this.hotMoveFragment=hotMoveFragment;
    }
        ...
        viewHolder.checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(viewHolder.checkBox.isChecked()){
                    hotMoveFragment.init(list.get(i).getId());
//                    list.get(i).setFollowMovie(1);
                }else{
                    hotMoveFragment.init1(list.get(i).getId());
